...
| Camera            | Basler acA1920-155um (IMX174, global shutter, USB3) | BSB 4041                              |
| C-mount adapter   | U-TV1X-2 (1×) already installed under U-CMAD3       | BSB 4041                              |
...
| ------------------------ | ---------------------------------------------------------------- | ----------------------------------- |
| Transducers (×2)         | PZT-5A, thickness-mode resonant near 741 kHz                     | We have this                        |
| Function generator ×2    | Two-channel or two units — 741 kHz CW, independent phase control | We have this                        |
...
| --------------------------------------------------- | ----------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Second RF amplifier                                 | Drive right PZT independently                               | Match gain to left channel for amplitude, or we are okay? balance                                                                                                                                                                                                                                                                                                                                    |
| Phase splitter / controller                         | Set φ_L − φ_R from 0 to π                                   | Some dual-channel function generators support this, but we need to verify this directly                                                                                                                                                                                                                                                                                                                         |
| Water-immersion tank                                | PZTs sit in water on both sides of PDMS walls               | Custom PDMS holder                                                                                                                                                                                                                                                                                                                                                 |
| PDMS mold (revised)                                 | Side walls ≤3 mm; ceiling 1–2 mm                            | Rework existing mold; thin                                                                                                                                                                                                                                                                                                                        |
| Amplitude attenuator (×1)                           | Balance p_L = p_R to within ~5% for symmetric nodes         | 3–6 dB fixed pad on one channel if gains, but we should have this in BSB4041 differ                                                                                                                                                                                                                                                                                                                                     |
...
## Notes and Known Issues to fix

- **Hg lamp (U-RFL-T):** Currently   at ~3.3 hours on a 300-hour rated bulb — well within safe operating life. Log hours after each session. Replace with USH-103OL ($270) at or before 300 hours, or upgrade to LED (Thorlabs SOLIS-470C, ~$1,000 including driver and adapter) when the bulb is due. NOT YET. 
...
- **C-mount adapter (Part A):** The U-TV1X-2 (1× relay) is already installed under U-CMAD3 on the BX51WI. The Basler acA1920-155um screws directly onto the U-CMAD3 — no additional adapter needed.
